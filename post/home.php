        ...
        <div class="postFormContainer">
            ...
            <form action="" class="postForm formContainer" method="post" enctype="multipart/form-data">
                ...
                <div class="desc mainInput">
                    ...
                    <div style="margin-left: 5cm;margin-top: -0.8cm;" class="iconContainer"><i title="Add Image" class="fa fa-image fa-2x" id="icon" data-story-edit-icon_photo></i>&nbsp;&nbsp;&nbsp;<i title="Add Video" class="fa fa-file-video-o fa-2x" aria-hidden="true" id="clip"></i></div>
                ...
                <div class="filesWrapper">
                 ...
                 <div> <button type="submit" style="display: inline-block;max-width:max-content;height: 1.8cm;margin-left: -6cm;margin-top: 0.7cm;">Post Now</button>
